...
class KVMSimulator implements Simulator {
    ...
    void registerSimulators(EnvSpec spec) {
        ...
        VFS.vfsHook(KVMConstant.KVM_BLOCK_COMMIT_VOLUME_PATH, spec) { BlockCommitResponse rsp, HttpEntity<String> e, EnvSpec espec ->
            ...
            rsp.setNewInstallPath(newInstallPath.pathString())
            return rsp
        }
