                ...
                bus.send(msg, new CloudBusCallBack(trigger) {
                    ...
                    public void run(MessageReply reply) {
                        if (reply.isSuccess()) {
                            ...
                            trigger.fail(operr(ORG_ZSTACK_NETWORK_SECURITYGROUP_10128, "Failed to apply security group rules to current VM[uuid:%s]",
                        ...
                        .run(new WhileDoneCompletion(trigger) {
                            ...
                            public void done(ErrorCodeList errorCodeList) {
                                if (errs.isEmpty()) {
                                    ...
                                    trigger.fail(operr(ORG_ZSTACK_NETWORK_SECURITYGROUP_10129, "Failed to apply security group rules to some VMs"));
                                }
                            }
                        });
            }
