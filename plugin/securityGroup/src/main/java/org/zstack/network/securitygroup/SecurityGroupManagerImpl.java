...
import static org.zstack.network.securitygroup.SecurityGroupConstant.SGParam.*;
            ...
            public void setup() {
                flow(new NoRollbackFlow() {
                    ...
                    public void run(FlowTrigger trigger, Map data) {
                        ...
                        data.put(SecurityGroupConstant.SGParam.SECURITY_GROUP_UUIDS, sgUuids);
                        data.put(SecurityGroupConstant.SGParam.SECURITY_GROUP_REFS, toDelete);
                ...
                flow(new NoRollbackFlow() {
                    ...
                    @Override
                    public void run(FlowTrigger trigger, Map data) {
                        List<String> sgUuids = (List<String>)data.get(SecurityGroupConstant.SGParam.SECURITY_GROUP_UUIDS);
                ...
                flow(new NoRollbackFlow() {
                    ...
                    @Override
                    public void run(FlowTrigger trigger, Map data) {
                        List<VmNicSecurityGroupRefVO> toDelete = (List<VmNicSecurityGroupRefVO>) data.get(SecurityGroupConstant.SGParam.SECURITY_GROUP_REFS);
