...
public class LocalStorageFactory implements PrimaryStorageFactory, Component,
    ...
    @Override
    @Transactional(readOnly = true)
    public Map<String, ExtensionHostMaintenancePolicy> getHostMaintenanceVmOperationPolicy(HostInventory host) {
        Map<String, ExtensionHostMaintenancePolicy> result = new HashMap<>();
        String sql = "select vm.uuid" +
        ...
        vmUuids.forEach(it -> result.put(it, ExtensionHostMaintenancePolicy.StopVm));
        return result;
    }
