...
public abstract class LocalStorageHypervisorBackend extends LocalStorageBase {
    ...
    abstract void handle(ReadVmInstanceMetadataOnPrimaryStorageMsg msg, String hostUuid, ReturnValueCompletion<ReadVmInstanceMetadataOnPrimaryStorageReply> completion);
