...
public abstract class LocalStorageHypervisorBackend extends LocalStorageBase {
    ...
    abstract void handle(DeleteVolumeSnapshotOnPrimaryStorageMsg msg, String hostUuid, ReturnValueCompletion<DeleteVolumeSnapshotOnPrimaryStorageReply> completion);
}
