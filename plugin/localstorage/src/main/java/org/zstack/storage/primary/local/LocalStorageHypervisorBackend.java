...
import org.zstack.header.storage.primary.DeleteVolumeSnapshotOnPrimaryStorageMsg;
...
public abstract class LocalStorageHypervisorBackend extends LocalStorageBase {
    ...
    abstract void handle(DeleteVolumeSnapshotOnPrimaryStorageMsg msg, String hostUuid, ReturnValueCompletion<DeleteVolumeSnapshotSelfOnPrimaryStorageReply> completion);
}
