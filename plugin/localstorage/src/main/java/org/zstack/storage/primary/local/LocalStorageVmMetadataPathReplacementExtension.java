...
@Component
public class LocalStorageVmMetadataPathReplacementExtension implements VmMetadataPathReplacementExtensionPoint {
    private static final CLogger logger = Utils.getLogger(LocalStorageVmMetadataPathReplacementExtension.class);
