...
public class KvmBackend extends HypervisorBackend {
    ...
    void handle(DeleteVolumeSnapshotSelfOnPrimaryStorageMsg msg, ReturnValueCompletion<DeleteVolumeSnapshotSelfOnPrimaryStorageReply> completion) {
        ...
        hmsg.setSrcSnapshotPath(msg.getSrcSnapshotPath());
        hmsg.setDstSnapshotPath(msg.getDstSnapshotPath());
        hmsg.setDeleteByBlockCommit(msg.isDeleteByBlockCommit());
        hmsg.setSrcSnapshotSize(msg.getSrcSnapshotSize());
        hmsg.setDstSnapshotSize(msg.getDstSnapshotSize());
        ...
        bus.send(hmsg, new CloudBusCallBack(msg) {
            ...
            public void run(MessageReply reply) {
                ...
                ret.setNewInstallPath(treply.getNewInstallPath());
                completion.success(ret);
            }
        });
    }
