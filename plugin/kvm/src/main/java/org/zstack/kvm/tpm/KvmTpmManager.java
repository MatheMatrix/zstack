...
public class KvmTpmManager extends AbstractService {
    ...
    private void handle(APIGetTpmCapabilityMsg msg) {
        ...
        if (vm.getHostUuid() != null) {
            view.setSwtpmVersion(SWTPM_VERSION.getTokenByResourceUuid(vm.getHostUuid(), EDK_RPM_TOKEN));
        } else if (vm.getLastHostUuid() != null) {
            view.setSwtpmVersion(SWTPM_VERSION.getTokenByResourceUuid(vm.getLastHostUuid(), EDK_RPM_TOKEN));
        }
