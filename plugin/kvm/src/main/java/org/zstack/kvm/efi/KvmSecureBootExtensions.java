...
public class KvmSecureBootExtensions implements KVMStartVmExtensionPoint,
    ...
    public static String buildTpmStateFilePath(String vmUuid) {
        return String.format(TPM_STATE_FILE_PATH_FORMAT, hyphenatedUuid(vmUuid));
    }

    public static String buildNvramSnapshotBackupFilePath(String vmUuid) {
        return buildNvramFilePath(vmUuid);
    }

    public static String buildTpmStateSnapshotBackupFilePath(String vmUuid) {
        return buildTpmStateFilePath(vmUuid);
    }

    private static String hyphenatedUuid(String uuid) {
    ...
    public static String buildPathForVmHostFileType(VmHostFileType type, String vmUuid) {
        switch (type) {
            ...
            case TpmState:
                return buildTpmStateFilePath(vmUuid);
            default:
                throw new IllegalArgumentException(String.format("unsupported VM host file type: %s", type));
        }
    }
