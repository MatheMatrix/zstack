...
public class KvmVmHostFileFactory {
    ...
    public AbstractVmHostFileBase createBase(VmHostFileVO file) {
        ...
        default: throw new OperationFailureException(operr("invalid VM host file type: " + file.getType()));
        }
    }
    ...
    public AbstractVmHostBackupFileBase createBackupBase(VmHostBackupFileVO backupFile) {
        ...
        default: throw new OperationFailureException(operr("invalid VM host file type: " + backupFile.getType()));
        }
    }
