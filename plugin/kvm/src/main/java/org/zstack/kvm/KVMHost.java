...
public class KVMHost extends HostBase implements Host {
    ...
    protected void handleLocalMessage(Message msg) {
        ...
        } else if (msg instanceof GetSoftwarePackageDownloadProgressMsg) {
            handle((GetSoftwarePackageDownloadProgressMsg) msg);
        } else {
    ...
    private void handle(GetSoftwarePackageDownloadProgressMsg msg) {
