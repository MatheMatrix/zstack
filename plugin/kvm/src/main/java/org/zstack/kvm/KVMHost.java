...
public class KVMHost extends HostBase implements Host {
    ...
    private String blockPullVolumePath;
    ...
    public KVMHost(KVMHostVO self, KVMHostContext context) {
        ...
        blockPullVolumePath = ub.build().toString();
    ...
    protected void handleLocalMessage(Message msg) {
        ...
        } else if (msg instanceof org.zstack.header.host.CommitVolumeSnapshotSelfOnHypervisorMsg) {
            handle((CommitVolumeSnapshotSelfOnHypervisorMsg) msg);
        } else if (msg instanceof PullVolumeSnapshotSelfOnHypervisorMsg) {
            handle((PullVolumeSnapshotSelfOnHypervisorMsg) msg);
    ...
    private void handle(CommitVolumeSnapshotSelfOnHypervisorMsg msg) {
    ...
    private void commitVolumeSnapshot(final CommitVolumeSnapshotSelfOnHypervisorMsg msg, final NoErrorCompletion completion) {
        checkStateAndStatus();

        final CommitVolumeSnapshotSelfOnHypervisorReply reply = new CommitVolumeSnapshotSelfOnHypervisorReply();

        BlockCommitVolumeSnapshotCmd cmd = new BlockCommitVolumeSnapshotCmd();
        ...
        cmd.setTop(msg.getSrcSnapshotPath());
        cmd.setBase(msg.getDstSnapshotPath());
        ...
        cmd.setSnapshotChainFromSrcToDst(msg.getSnapshotChainFromSrcToDst());
            ...
            public void setup() {
                flow(new NoRollbackFlow() {
                    ...
                    public void run(FlowTrigger trigger, Map data) {
                        extEmitter.beforeCommitVolumeSnapshot((KVMHostInventory) getSelfInventory(), msg, new Completion(trigger) {
                            @Override
                            public void success() {
                                trigger.next();
                            }
                ...
                flow(new NoRollbackFlow() {
                    ...
                    @Override
                    public void run(FlowTrigger trigger, Map data) {
                        new Http<>(blockCommitVolumePath, cmd, BlockCommitVolumeSnapshotResponse.class).call(new ReturnValueCompletion<BlockCommitVolumeSnapshotResponse>(msg, trigger) {
                            @Override
                            public void success(BlockCommitVolumeSnapshotResponse ret) {
                                if (!ret.isSuccess()) {
                                    ErrorCode err = operr("operation error, because:%s", ret.getError());
                                    extEmitter.failedToCommitVolumeSnapshot((KVMHostInventory) getSelfInventory(), msg, ret, err);
                                    trigger.fail(err);
                                    return;
                                }
                            ...
                            @Override
                            public void fail(ErrorCode errorCode) {
                                extEmitter.failedToCommitVolumeSnapshot((KVMHostInventory) getSelfInventory(), msg, null, errorCode);
                                trigger.fail(errorCode);
                            }
                        });
                    }
                ...
                flow(new NoRollbackFlow() {
                    ...
                    @Override
                    public void run(FlowTrigger trigger, Map data) {
                        extEmitter.afterCommitVolumeSnapshot((KVMHostInventory) getSelfInventory(), msg, reply, new Completion(trigger) {
                            @Override
                            public void success() {
                                trigger.next();
                            }
                            ...
                            @Override
                            public void fail(ErrorCode errorCode) {
                                logger.debug(String.format("failed to call afterDeleteVolumeSnapshotSelf, %s", errorCode));
                                trigger.next();
                            }
                        });
                    }
    ...
    private void handle(final PullVolumeSnapshotSelfOnHypervisorMsg msg) {
    ...
    private void pullVolumeSnapshot(PullVolumeSnapshotSelfOnHypervisorMsg msg, final NoErrorCompletion completion) {
        checkStateAndStatus();

        final PullVolumeSnapshotSelfOnHypervisorReply reply = new PullVolumeSnapshotSelfOnHypervisorReply();

        BlockPullVolumeCmd cmd = new BlockPullVolumeCmd();
        cmd.setVmUuid(msg.getVolume().getVmInstanceUuid());
        cmd.setBase(msg.getBase());
        cmd.setVmUuid(msg.getVolume().getVmInstanceUuid());
        cmd.setVolume(VolumeTO.valueOf(msg.getVolume(), (KVMHostInventory) getSelfInventory()));

        FlowChain chain = FlowChainBuilder.newShareFlowChain();
        chain.setName(String.format("pull-snapshot-for-volume-%s", msg.getVolume().getUuid()));
        chain.then(new ShareFlow() {
            @Override
            public void setup() {
                flow(new NoRollbackFlow() {
                    String __name__ = String.format("before-pull-snapshot-for-volume-%s", msg.getVolume().getUuid());

                    @Override
                    public void run(FlowTrigger trigger, Map data) {
                        extEmitter.beforePullVolumeSnapshot((KVMHostInventory) getSelfInventory(), msg, new Completion(trigger) {
                            @Override
                            public void success() {
                                trigger.next();
                            }
                ...
                flow(new NoRollbackFlow() {
                    String __name__ = String.format("do-pull-snapshot-for-volume-%s", msg.getVolume().getUuid());

                    @Override
                    public void run(FlowTrigger trigger, Map data) {
                        new Http<>(blockPullVolumePath, cmd, BlockPullVolumeResponse.class)
                                .call(new ReturnValueCompletion<BlockPullVolumeResponse>(msg, completion) {
                                    @Override
                                    public void success(BlockPullVolumeResponse ret) {
                                        if (!ret.isSuccess()) {
                                            ErrorCode err = operr("operation error, because:%s", ret.getError());
                                            extEmitter.failedToPullVolumeSnapshot((KVMHostInventory) getSelfInventory(), msg, ret, err);
                                            trigger.fail(err);
                                            return;
                                        }
                                    ...
                                    @Override
                                    public void fail(ErrorCode errorCode) {
                                        extEmitter.failedToPullVolumeSnapshot((KVMHostInventory) getSelfInventory(), msg, null, errorCode);
                                        completion.done();
                                    }
                                });
                    }
                ...
                flow(new NoRollbackFlow() {
                    String __name__ = String.format("after-pull-snapshot-for-volume-%s", msg.getVolume().getUuid());

                    @Override
                    public void run(FlowTrigger trigger, Map data) {
                        extEmitter.afterPullVolumeSnapshot((KVMHostInventory) getSelfInventory(), msg, reply, new Completion(trigger) {
                            @Override
                            public void success() {
                                trigger.next();
                            }
