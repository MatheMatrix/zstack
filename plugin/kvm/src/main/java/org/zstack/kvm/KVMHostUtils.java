...
public class KVMHostUtils {
    ...
    /**
     * TLS cert IP list for ansible deploy: detectedIps plus EXTRA_IPS tag.
    ...
    /** Pure function for unit tests: detectedIps plus extraIps, fall back to mgmtIp when detected empty. */
