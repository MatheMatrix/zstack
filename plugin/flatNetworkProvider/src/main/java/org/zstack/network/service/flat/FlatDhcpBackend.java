...
public class FlatDhcpBackend extends AbstractService implements NetworkServiceDhcpBackend, KVMHostConnectExtensionPoint,
    ...
    * */
    private void updateL3NetworkIpamState(String l3Uuid, Boolean state) {
        SQL.New(L3NetworkVO.class).eq(L3NetworkVO_.uuid, l3Uuid)
                .set(L3NetworkVO_.type, L3NetworkConstant.L3_BASIC_NETWORK_TYPE)
                .set(L3NetworkVO_.enableIPAM, state).update();
    }
