        ...
        bus.send(msg, new CloudBusCallBack(chain) {
            ...
            public void run(MessageReply reply) {
                ...
                if (ret.isSuccess()) {
                    ...
                    ErrorCode err = operr(ORG_ZSTACK_NETWORK_SERVICE_VIRTUALROUTER_PORTFORWARDING_10000, "failed to sync port forwarding rules served by virtual router[name: %s, uuid: %s], because %s",
