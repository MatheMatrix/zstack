        ...
        bus.send(msg, new CloudBusCallBack(chain) {
            ...
            public void run(MessageReply reply) {
                ...
                if (ret.isSuccess()) {
                    ...
                    ErrorCode err = operr(ORG_ZSTACK_NETWORK_SERVICE_VIRTUALROUTER_PORTFORWARDING_10006, "failed to revoke port forwarding rules %s, because %s", JSONObjectUtil.toJsonString(to), ret.getError());
                    chain.fail(err);
                }
            }
        });
