        ...
        chain.then(new NoRollbackFlow() {
            ...
            public void run(final FlowTrigger trigger, final Map data) {
                ...
                if (!StringUtils.isEmpty(specificVrUuid)) {
                    ...
                    data.put(VirtualRouterConstant.VirtualRouterParam.VR.toString(), VirtualRouterVmInventory.valueOf(virtualRouterVmVO));
                    trigger.next();
                    return;
                }
                ...
                vrMgr.acquireVirtualRouterVm(s, new ReturnValueCompletion<VirtualRouterVmInventory>(trigger){
                    ...
                    public void success(VirtualRouterVmInventory returnValue) {
                        data.put(VirtualRouterConstant.VirtualRouterParam.VR.toString(), returnValue);
                        trigger.next();
                    }
