...
public class VirtualRouterCreatePublicVipFlow implements Flow {
    ...
    public void run(final FlowTrigger chain, Map data) {
        ...
        Boolean snat = (Boolean) data.get(VirtualRouterConstant.VRouterParam.SNAT.toString());
        boolean isNewCreated = data.containsKey(VirtualRouterConstant.VRouterParam.IS_NEW_CREATED.toString());
        ...
        *  2. after attach nic flow, including ha virtual router, non-ha virtual router */
        ...
        /* use for rollback */
        data.put(VirtualRouterConstant.VRouterParam.PUB_VIP_UUID.toString(), vips);
    ...
    public void rollback(FlowRollback chain, Map data) {
        List<VipInventory> vips = (List<VipInventory>) data.get(VirtualRouterConstant.VRouterParam.PUB_VIP_UUID.toString());
