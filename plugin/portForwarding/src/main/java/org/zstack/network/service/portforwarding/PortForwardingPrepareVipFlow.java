...
import org.zstack.network.service.portforwarding.PortForwardingConstant.PortForwardingParams;
...
public class PortForwardingPrepareVipFlow implements Flow {
    ...
    public void run(final FlowTrigger trigger, final Map data) {
        ...
        boolean needLockVip = data.containsKey(PortForwardingParams.NEED_LOCK_VIP.toString());
