...
public class DetachPortForwardingFlow extends NoRollbackFlow {
    ...
    public void run(final FlowTrigger trigger, Map data) {
        String providerType = (String) data.get(PortForwardingConstant.PFParams.PORTFORWARDING_SERVICE_PROVIDER_TYPE.toString());
        final PortForwardingStruct struct = (PortForwardingStruct) data.get(PortForwardingConstant.PFParams.PORTFORWARDING_STRUCT.toString());
