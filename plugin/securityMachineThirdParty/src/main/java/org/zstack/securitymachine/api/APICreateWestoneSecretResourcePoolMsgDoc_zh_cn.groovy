...
doc {
    ...
    rest {
        request {
			url "POST /v1/secret-resource-pool/westone"

			header (Authorization: 'OAuth the-session-uuid')

            clz APICreateWestoneSecretResourcePoolMsg.class
