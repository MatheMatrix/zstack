...
public class LdapUpgradeExtension implements Component {
    ...
    private void updateLdapUidToLdapDn() {
        ...
        try {
            ...
            List<ImportAccountRefVO> refs = Q.New(ImportAccountRefVO.class).list();
            for(ImportAccountRefVO ref : refs){
    ...
    private void update(LdapTemplate ldapTemplate, ImportAccountRefVO ref){
        String uid = ref.getKeyFromImportSource();

        AndFilter filter = new AndFilter();
        filter.and(new EqualsFilter("uid", ref.getKeyFromImportSource()));
