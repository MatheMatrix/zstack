...
public class LdapUtil {
    ...
    public ImportAccountRefVO findLdapAccountRefVO(String ldapDn){
        ImportAccountRefVO ldapAccountRefVO = Q.New(ImportAccountRefVO.class)
                .eq(ImportAccountRefVO_.keyFromImportSource, ldapDn)
                .find();
     ...
     */
    private ImportAccountRefVO findLdapAccountRefByAffiliatedGroup(String ldapDn){

        List<String> ldapDnList = Q.New(ImportAccountRefVO.class)
        ...
        List<ImportAccountRefVO> vos = Q.New(ImportAccountRefVO.class)
                .in(ImportAccountRefVO_.keyFromImportSource, dnGroups)
                .list();
        ...
        List<String> accountList = vos.stream().map(ImportAccountRefVO::getAccountUuid).distinct().collect(Collectors.toList());
