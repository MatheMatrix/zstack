...
import org.zstack.identity.imports.message.CreateImportSourceMsg;
import org.zstack.identity.imports.message.CreateImportSourceReply;
...
public class AccountImportsManager extends AbstractService {
    ...
    public void handleMessage(Message msg) {
        if (msg instanceof CreateImportSourceMsg) {
            handle(((CreateImportSourceMsg) msg));
        } else if (msg instanceof ImportSourceMessage) {
    ...
    private void handle(CreateImportSourceMsg message) {
        CreateImportSourceReply reply = new CreateImportSourceReply();
