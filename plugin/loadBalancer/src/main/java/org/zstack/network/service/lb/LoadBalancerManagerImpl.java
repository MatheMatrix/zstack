            ...
            public void setup() {
                ...
                flow(new Flow() {
                    ...
                    public void run(FlowTrigger trigger, Map data) {
                        ...
                        data.put(LoadBalancerConstants.LoadBalancerParam.LOAD_BALANCER_VO, vo);
                        trigger.next();
                    }

                    @Override
                    public void rollback(FlowRollback trigger, Map data) {
                        LoadBalancerVO vo = (LoadBalancerVO)data.get(LoadBalancerConstants.LoadBalancerParam.LOAD_BALANCER_VO);
                        if (vo != null) {
