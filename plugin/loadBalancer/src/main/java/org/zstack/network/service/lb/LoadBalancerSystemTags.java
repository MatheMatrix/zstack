...
public class LoadBalancerSystemTags {
    ...
    public static final String TCP_PROXYPROTOCOL_TOKEN = "tcpProxyProtocol";
    public static PatternedSystemTag TCP_PROXYPROTOCOL = new PatternedSystemTag(String.format("tcpProxyProtocol::{%s}", TCP_PROXYPROTOCOL_TOKEN), LoadBalancerListenerVO.class);
