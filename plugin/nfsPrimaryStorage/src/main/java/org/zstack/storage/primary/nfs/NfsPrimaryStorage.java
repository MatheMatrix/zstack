...
public class NfsPrimaryStorage extends PrimaryStorageBase {
    ...
    protected void handle(DeleteVolumeSnapshotOnPrimaryStorageMsg msg) {
        ...
        if (Objects.equals(msg.getDirection(), DeleteVolumeSnapshotDirection.Pull.toString())) {
            backend.pullSnapshot(msg, hostUuid, new ReturnValueCompletion<DeleteVolumeSnapshotOnPrimaryStorageReply>(msg) {
                @Override
                public void success(DeleteVolumeSnapshotOnPrimaryStorageReply r) {
                    bus.reply(msg, r);
                }
            ...
            backend.commitSnapshot(msg, hostUuid, new ReturnValueCompletion<DeleteVolumeSnapshotOnPrimaryStorageReply>(msg) {
                @Override
                public void success(DeleteVolumeSnapshotOnPrimaryStorageReply r) {
                    bus.reply(msg, r);
                }
