...
public interface NfsPrimaryStorageBackend {
    ...
    void pullSnapshot(DeleteVolumeSnapshotOnPrimaryStorageMsg msg, String hostUuid, ReturnValueCompletion<DeleteVolumeSnapshotOnPrimaryStorageReply> completion);

    void commitSnapshot(DeleteVolumeSnapshotOnPrimaryStorageMsg msg, String hostUuid, ReturnValueCompletion<DeleteVolumeSnapshotOnPrimaryStorageReply> completion);
