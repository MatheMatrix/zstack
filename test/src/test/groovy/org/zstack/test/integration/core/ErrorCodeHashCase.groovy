...
class ErrorCodeHashCase extends SubCase{
    ...
    void test() {
        ...
        err1 = Platform.operr(ORG_ZSTACK_TEST_INTEGRATION_CORE_10054, "test error")
        err2 = Platform.operr(ORG_ZSTACK_TEST_INTEGRATION_CORE_10055, "test error")
        err3 = Platform.argerr(ORG_ZSTACK_TEST_INTEGRATION_CORE_10056, "test error")
