...
class DistanceElaborationCase extends SubCase {
    ...
    void testElaboration1() {
        def err = org.zstack.core.Platform.operr(ORG_ZSTACK_TEST_INTEGRATION_CORE_10040, "arg 'startTime' should format like 'yyyy-MM-dd HH:mm:ss' or '1545380003000'") as ErrorCode
