...
public class AddModelServiceAction extends AbstractAction {
    ...
    @Param(required = false, validValues = {"Endpoint","FineTune","ModelEval","App"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    ...
    @Param(required = false, validValues = {"vLLM","Diffusers","Transformers","sentence_transformers","llama.cpp","Ollama"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
