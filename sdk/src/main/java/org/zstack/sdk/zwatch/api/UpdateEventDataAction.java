...
public class UpdateEventDataAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.zwatch.api.UpdateEventDataResult value;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.zwatch.api.UpdateEventDataResult value = res.getResult(org.zstack.sdk.zwatch.api.UpdateEventDataResult.class);
        ret.value = value == null ? new org.zstack.sdk.zwatch.api.UpdateEventDataResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/zwatch/events/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateEventData";
        return info;
    }
