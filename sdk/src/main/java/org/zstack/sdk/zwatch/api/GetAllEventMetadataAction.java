...
public class GetAllEventMetadataAction extends AbstractAction {
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.zwatch.api.GetAllEventMetadataResult value = res.getResult(org.zstack.sdk.zwatch.api.GetAllEventMetadataResult.class);
        ret.value = value == null ? new org.zstack.sdk.zwatch.api.GetAllEventMetadataResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "GET";
        info.path = "/zwatch/events/meta-data";
