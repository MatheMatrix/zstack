...
public class UpdateCSPSecretResourcePoolAction extends AbstractAction {
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/secret-resource-pools/csp/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateCSPSecretResourcePool";
        return info;
    }
