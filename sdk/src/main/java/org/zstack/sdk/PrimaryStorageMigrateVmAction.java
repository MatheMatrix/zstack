...
public class PrimaryStorageMigrateVmAction extends AbstractAction {
    ...
    @Param(required = false, validValues = {"ThickFirst","ThinFirst","FollowVolumeFirst","FollowDestPrimaryStorage"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
