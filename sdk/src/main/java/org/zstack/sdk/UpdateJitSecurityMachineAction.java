...
public class UpdateJitSecurityMachineAction extends AbstractAction {
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/security-machines/jida/auth-gateway/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateJitSecurityMachine";
        return info;
    }
