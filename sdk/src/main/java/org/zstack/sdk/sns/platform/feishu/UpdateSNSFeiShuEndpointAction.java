...
public class UpdateSNSFeiShuEndpointAction extends AbstractAction {
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/sns/application-endpoints/feishu/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateSNSFeiShuEndpoint";
        return info;
    }
