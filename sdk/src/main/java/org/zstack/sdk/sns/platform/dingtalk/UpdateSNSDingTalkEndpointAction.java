...
public class UpdateSNSDingTalkEndpointAction extends AbstractAction {
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/sns/application-endpoints/ding-talk/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateSNSDingTalkEndpoint";
        return info;
    }
