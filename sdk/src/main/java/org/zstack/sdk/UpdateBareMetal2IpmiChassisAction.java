...
public class UpdateBareMetal2IpmiChassisAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.UpdateBareMetal2ChassisResult value;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.UpdateBareMetal2ChassisResult value = res.getResult(org.zstack.sdk.UpdateBareMetal2ChassisResult.class);
        ret.value = value == null ? new org.zstack.sdk.UpdateBareMetal2ChassisResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/baremetal2/chassis/ipmi/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateBareMetal2IpmiChassis";
        return info;
    }
