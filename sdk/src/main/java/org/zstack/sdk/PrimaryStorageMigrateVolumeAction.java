...
public class PrimaryStorageMigrateVolumeAction extends AbstractAction {
    ...
    @Param(required = false, validValues = {"ThickProvisioning","ThinProvisioning","FollowVolume","FollowDestPrimaryStorage"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
