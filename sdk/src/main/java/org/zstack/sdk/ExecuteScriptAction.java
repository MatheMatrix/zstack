...
public class ExecuteScriptAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.ExecuteScriptResult value;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.ExecuteScriptResult value = res.getResult(org.zstack.sdk.ExecuteScriptResult.class);
        ret.value = value == null ? new org.zstack.sdk.ExecuteScriptResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.needPoll = true;
        info.parameterName = "executeScript";
        return info;
    }
