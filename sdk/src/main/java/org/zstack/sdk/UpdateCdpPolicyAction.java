...
public class UpdateCdpPolicyAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.UpdateCdpPolicyResult value;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.UpdateCdpPolicyResult value = res.getResult(org.zstack.sdk.UpdateCdpPolicyResult.class);
        ret.value = value == null ? new org.zstack.sdk.UpdateCdpPolicyResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/cdp-backup-storage/policy/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateCdpPolicy";
        return info;
    }
