...
public class CreateVmFromVolumeBackupAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.heder.storage.volume.backup.CreateVmFromVolumeBackupResult value;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.heder.storage.volume.backup.CreateVmFromVolumeBackupResult value = res.getResult(org.zstack.heder.storage.volume.backup.CreateVmFromVolumeBackupResult.class);
        ret.value = value == null ? new org.zstack.heder.storage.volume.backup.CreateVmFromVolumeBackupResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.path = "/vm-instances/from/vm-backup/{backupUuid}";
