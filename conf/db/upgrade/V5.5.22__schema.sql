...
-- Support HA vRouter DNS record service values that encode domain and IPv4 address.
ALTER TABLE `zstack`.`VpcHaGroupNetworkServiceRefVO` MODIFY COLUMN `networkServiceUuid` varchar(512) NOT NULL;
