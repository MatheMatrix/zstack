...
create table `zstack`.`AccountGroupVO` (
...
create table `zstack`.`AccountGroupAccountRefVO` (
    `id` bigint unsigned not null unique AUTO_INCREMENT,
    `accountUuid` char(32) not null,
...
create table `zstack`.`AccountGroupRoleRefVO` (
    `id` bigint unsigned not null unique AUTO_INCREMENT,
    `roleUuid` char(32) not null,
    `groupUuid` char(32) not null,
    `lastOpDate` timestamp on update CURRENT_TIMESTAMP,
...
create table `zstack`.`AccountGroupResourceRefVO` (
    `id` bigint unsigned not null unique AUTO_INCREMENT,
    `resourceUuid` char(32) not null,
    `groupUuid` char(32) not null,
    `lastOpDate` timestamp on update CURRENT_TIMESTAMP,
