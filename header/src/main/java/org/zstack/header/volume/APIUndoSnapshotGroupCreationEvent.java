...
public class APIUndoSnapshotGroupCreationEvent extends APIEvent {
    private VolumeInventory inventory;

    public APIUndoSnapshotGroupCreationEvent() {
    }

    public APIUndoSnapshotGroupCreationEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIUndoSnapshotGroupCreationEvent __example__() {
        APIUndoSnapshotGroupCreationEvent event = new APIUndoSnapshotGroupCreationEvent();
