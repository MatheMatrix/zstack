...
public class GetFileDownloadProgressReply extends MessageReply {
    ...
    private String uploadInstallPath;
    ...
    public String getUploadInstallPath() {
        return uploadInstallPath;
    }

    public void setUploadInstallPath(String uploadInstallPath) {
        this.uploadInstallPath = uploadInstallPath;
    }
}
