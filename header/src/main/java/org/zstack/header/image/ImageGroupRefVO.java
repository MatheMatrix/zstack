...
public class ImageGroupRefVO implements Serializable {
    ...
    @Column
    @ForeignKey(parentEntityClass = ImageGroupVO.class, onDeleteAction = ForeignKey.ReferenceOption.CASCADE)
    ...
    public void setMediaType(ImageConstant.ImageMediaType type) {
        this.mediaType = type;
    }
