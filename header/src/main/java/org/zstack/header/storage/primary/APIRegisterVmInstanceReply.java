...
public class APIRegisterVmInstanceReply extends APIEvent {
    private VmInstanceInventory inventory;

    public APIRegisterVmInstanceReply() {
    }

    public APIRegisterVmInstanceReply(String apiId) {
        super(apiId);
    }
    ...
    public static APIRegisterVmInstanceReply __example__() {
        APIRegisterVmInstanceReply event = new APIRegisterVmInstanceReply();
