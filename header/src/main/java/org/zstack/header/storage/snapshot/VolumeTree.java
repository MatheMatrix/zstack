...
public class VolumeTree {
    ...
    public class VolumeSnapshotDeletionContext {
        ...
        List<VolumeSnapshotInventory> snapshotChainFromDstToSrc = new ArrayList<>();
        ...
        private void handleSnapshotWithoutParent() {
            ...
            if (isCurrent && Objects.equals(dstSnapshotLeaf.getUuid(), volume.getUuid()) && dstSnapshotLeaf.getParent() != null) {
                newLatestSnapshotUuid = dstSnapshotLeaf.getUuid();
            }
        }
        ...
        private void handleSnapshotWithParent() {
            ...
            fillSnapshotChainWhichStatusIsDeletedAndWithSingleParent(targetParentSnapshotLeaf);
            VolumeSnapshotLeaf parentLeaf = getParentLeaf(targetSnapshotLeaf);
            ...
            if (Objects.equals(direction, DeleteVolumeSnapshotContent.COMMIT)) {
                srcSnapshotLeaf = childrenLeaf;
                dstSnapshotLeaf = parentLeaf;
                newParentUuid = dstSnapshotLeaf.getParent() == null ? null : dstSnapshotLeaf.getParent().getUuid();
                srcChildrenInstallPath = srcSnapshotLeaf.getChildren().stream().map(leaf ->
                        leaf.getInventory().getPrimaryStorageInstallPath()).collect(Collectors.toList());
            }

            srcSnapshotLeaf = parentLeaf;
            dstSnapshotLeaf = childrenLeaf;
            newParentUuid = dstSnapshotLeaf.getParent() == null ? null : dstSnapshotLeaf.getUuid();
        }
        ...
        private void setSnapshotChainFromDstToSrc() {
        ...
        private boolean isOnlyCommitAllowed(VolumeTree.VolumeSnapshotLeaf leaf) {
            return isCurrent && leaf != null && !Objects.equals(leaf.getUuid(), volume.getUuid())
                    && aliveChainSnapshotUuids.contains(leaf.getUuid())
        ...
        public VolumeSnapshotInventory getSrcParentSnapshotInv() {
            return srcSnapshotLeaf == null ? null : srcSnapshotLeaf.getParent().getInventory();
        }
