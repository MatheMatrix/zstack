...
public class APITakeoverPrimaryStorageEvent extends APIEvent {
    ...
    /**
     * Reconnect result after takeover: SUCCESS / FAILED / NOT_ATTEMPTED
     */
    private String reconnectResult;
    ...
    public void setReconnectResult(String reconnectResult) {
    ...
    public static APITakeoverPrimaryStorageEvent __example__() {
        ...
        event.setReconnectResult("SUCCESS");
        return event;
    }
}