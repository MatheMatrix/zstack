...
/**
 * SharedBlock 元数据存储的容量常量�?Payload 大小保护阈值�?
 *
 * <p>SharedBlock（sblk）使用固定大小的 LV 存储 VM 元数据，采用�?Slot 布局�?
 * <pre>
 ...
 * </pre>
 *
 * @see <a href="vm-metadata-02b §10.0">Part 02b §10.0 容量公式与常�?/a>
 */
