...
public class APICreateVmInstanceFromVmTemplateEvent extends APIEvent {
    private VmInstanceInventory inventory;

    public APICreateVmInstanceFromVmTemplateEvent() {
        super(null);
    }

    public APICreateVmInstanceFromVmTemplateEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APICreateVmInstanceFromVmTemplateEvent __example__() {
        APICreateVmInstanceFromVmTemplateEvent evt = new APICreateVmInstanceFromVmTemplateEvent();
