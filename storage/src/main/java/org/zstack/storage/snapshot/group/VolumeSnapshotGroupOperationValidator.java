...
public class VolumeSnapshotGroupOperationValidator extends ScatteredValidator {
    ...
    public enum VolumeSnapsOperation {
        CREATE,
        REVERT,
    }
    ...
    public static List<Method> getInvokeMethods(VolumeSnapsOperation operation) {
        if (VolumeSnapsOperation.CREATE.equals(operation)) {
            return creationValidateMethods;
        } else if (VolumeSnapsOperation.REVERT.equals(operation)) {
    ...
    public static void validate(String vmUuid, VolumeSnapsOperation operation) {
