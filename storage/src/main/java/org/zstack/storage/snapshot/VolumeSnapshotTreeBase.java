    ...
    private void deleteOnlySelf(FlowChain chain, final VolumeSnapshotDeletionMsg msg, NoErrorCompletion completion) {
        ...
        if (volume.getVmInstanceUuid() != null) {
            ...
            if (vmInstanceState != VmInstanceState.Running && vmInstanceState != VmInstanceState.Paused
                    && vmInstanceState != VmInstanceState.Stopped) {
        ...
        VolumeTree.VolumeSnapshotDeletionContext context =
                currentVolumeTree.createDeletionContext(currentSnapshotVO, vmInstanceState, msg.isLatest());
            ...
            private void setupDeleteSnapshotOnlySelfFlows() {
                ...
                flow(new NoRollbackFlow() {
                    ...
                    public void run(FlowTrigger trigger, Map data) {
                        ...
                        bmsg.setSrcSnapshotPath(srcSnapshotInv.getPrimaryStorageInstallPath());
                        bmsg.setDstSnapshotPath(dstSnapshotInv == null ? null : dstSnapshotInv.getPrimaryStorageInstallPath());
                        bmsg.setSrcSnapshotSize(srcSnapshotInv.getSize());
                        bmsg.setDstSnapshotSize(dstSnapshotInv == null ? 0 : dstSnapshotInv.getSize());
                        bmsg.setDeleteByBlockCommit(context.isDeleteByBlockCommit());
                        ...
                        bmsg.setSnapshotChainFromSrcToDst(context.getSnapshotChainFromSrcToDst());
                        ...
                        bus.send(bmsg, new CloudBusCallBack(trigger) {
                            ...
                            public void run(MessageReply reply) {
                                ...
                                if (context.isDeleteByBlockCommit()) {
                                    updateInstallPath();
                                }
                                updateParent();
                                updateDistance();
                            ...
                            private void updateDistance() {
                                int distanceDifferenceValue;
                                if (context.isDeleteByBlockCommit()) {
                                    DebugUtils.Assert(dstSnapshotInv != null, "dstSnapshotInv should not be null");
                                    distanceDifferenceValue = srcSnapshotInv.getDistance() - dstSnapshotInv.getDistance();
                                } else {
                                    distanceDifferenceValue = dstSnapshotInv != null ?
                                            srcSnapshotInv.getDistance() - dstSnapshotInv.getDistance() + 1 : srcSnapshotInv.getDistance();
                                }
