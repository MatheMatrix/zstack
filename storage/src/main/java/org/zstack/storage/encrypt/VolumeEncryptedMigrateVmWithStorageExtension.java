...
public class VolumeEncryptedMigrateVmWithStorageExtension implements KvmMigrateVmWithStorageExtensionPoint {
            ...
            for (VolumeVO sourceVolume : volumesToMigrate) {
                ...
                volumeLuksSecrets.put(targetVolumeUuid,
                        volumeEncryptedSecretHelper.resolveOrDefineSecretForVolume(
                                dstHost.getUuid(), vm.getUuid(), targetVolumeUuid));
            }
        } catch (Exception e) {
    ...
    @Override
    public VolumeLuksAgentSpec prepareVolumeLuksAgentSpec(String hostUuid, VolumeInventory volume) {
        ...
        spec.setEncryptLuksSecretMaterialFilePath(
                volumeEncryptedSecretHelper.prepareLuksSecretMaterialFileOnHost(hostUuid, volume.getUuid()));
        return spec;
    }
