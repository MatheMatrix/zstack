                ...
                flow(new Flow() {
                    ...
                    public void run(FlowTrigger trigger, Map data) {
                        ...
                        if (rst == 0) {
                            ...
                            trigger.fail(operr(ORG_ZSTACK_CONSOLE_10002, "failed to configure consoleProxyOverriddenIp[code:%d] or consoleProxyPort[code:%d]"));
                        }
                    }
                ...
                flow(new NoRollbackFlow() {
                    ...
                    public void run(FlowTrigger trigger, Map data) {
                        ...
                        bus.send(rmsg, new CloudBusCallBack(trigger) {
                            ...
                            public void run(MessageReply reply) {
                                if (!reply.isSuccess()) {
                                    trigger.fail(operr(ORG_ZSTACK_CONSOLE_10003, "failed to reconnect console proxy"));
                                } else {
                                    trigger.next();
                                }
                            }
