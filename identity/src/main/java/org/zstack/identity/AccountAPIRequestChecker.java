            ...
            protected void scripts() {
                ...
                ts.forEach(t -> {
                    ...
                    if (!session.getAccountUuid().equals(resourceOwnerAccountUuid)) {
                        throw new OperationFailureException(err(ORG_ZSTACK_IDENTITY_10016, IdentityErrors.PERMISSION_DENIED, "operation denied. The resource[uuid: %s, type: %s,ownerAccountName:%s, ownerAccountUuid:%s] doesn't belong to the account[uuid: %s]",
