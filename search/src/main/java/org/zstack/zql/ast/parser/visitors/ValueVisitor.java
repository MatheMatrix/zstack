...
public class ValueVisitor extends ZQLBaseVisitor<ASTNode.Value> {
    ...
    private Object callAction(String apiStr, String outputStr, Map<String, Object> params) {
        ...
        if (o.isEmpty()) {
            throw new OperationFailureException(Platform.operr(ORG_ZSTACK_ZQL_AST_PARSER_VISITORS_10001, "output from [%s] is empty", apiStr));
        }
        ...
        try {
            ...
            if (ob != null) {
                throw new OperationFailureException(operr(ORG_ZSTACK_ZQL_AST_PARSER_VISITORS_10002, "call action[%s] failed, cause: %s", apiName, JSONObjectUtil.toJsonString(ob)));
            } else {
            ...
            if (e instanceof InvocationTargetException) {
                throw new OperationFailureException(operr(ORG_ZSTACK_ZQL_AST_PARSER_VISITORS_10003, ((InvocationTargetException) e).getTargetException().getMessage()));
            }
    ...
    private void setField(Object o, String key, Object value) {
        try {
            ...
            throw new OperationFailureException(operr(ORG_ZSTACK_ZQL_AST_PARSER_VISITORS_10005, e.getMessage()));
        }
    }
