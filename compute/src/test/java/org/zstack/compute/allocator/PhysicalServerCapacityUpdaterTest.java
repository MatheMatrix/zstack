 ...
 * couple this test to a future change.
 *
 * <p>Mocking strategy:
 * <ul>
...
public class PhysicalServerCapacityUpdaterTest {
    ...
    public void happy_mixed_roles_aggregate_consumed() {
        ...
        // available = 64GiB - (8GiB+4GiB) - 0 - 6.4GiB(memBuffer) = 45.6GiB
    ...
    public void edge_no_role_consumed_is_zero() {
        ...
        // available = 32 - 0 - 4 = 28
        assertEquals(28L, psc.getAvailableCpu());
        // available = 64GiB - 0 - 0(reservedMemory) - 6.4GiB(memBuffer) = 57.6GiB
        assertEquals(61847529063L, psc.getAvailableMemory());
        assertEquals(PhysicalServerCapacityState.Ready, psc.getCapacityState());
    }
    ...
    // differs — this test exists so a future refactor that conflates zero with
