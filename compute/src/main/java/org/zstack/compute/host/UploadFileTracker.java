...
public class UploadFileTracker {
    ...
    public void addTrackTask(String apiId, String hostUuid, String installPath) {
    ...
    public void runTrackTask(String apiId) {
        TrackContext ctx = ctxs.get(apiId);
        trackUpload(ctx.apiId, ctx.hostUuid, ctx.installPath);
    }

    public void trackUpload(String apiId, String hostUuid, String installPath) {
