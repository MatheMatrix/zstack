...
public class UploadFileTracker {
    ...
    void trackUpload(String taskUuid, String hostname,String url,Completion completion) {
        ...
        thdf.submitCancelablePeriodicTask(new CancelablePeriodicTask() {
            ...
            private void markCompletion(final GetImageDownloadProgressReply dr) {
                logger.debug(String.format("added file [name: %s, taskUuid: %s]", url, taskUuid));
            }
            ...
            public boolean run() {
                ...
                final GetFileDownloadProgressReply reply = getImageDownloadProgress(hostname);
    ...
    public GetFileDownloadProgressReply getImageDownloadProgress(String hostname) {
