...
public class ZoneBase extends AbstractZone {
	...
	protected void handle(APIChangeZoneStateMsg msg) {
        ...
        try {
            ...
            evt.setError(err(ORG_ZSTACK_COMPUTE_ZONE_10002, SysErrors.CHANGE_RESOURCE_STATE_ERROR, e.getMessage()));
            bus.publish(evt);
            return;
        }
    ...
    protected void handle(APIDeleteZoneMsg msg) {
        ...
        chain.done(new FlowDoneHandler(msg) {
            ...
            public void handle(ErrorCode errCode, Map data) {
                evt.setError(err(ORG_ZSTACK_COMPUTE_ZONE_10003, SysErrors.DELETE_RESOURCE_ERROR, errCode, errCode.getDetails()));
                bus.publish(evt);
            }
        }).start();
    }
