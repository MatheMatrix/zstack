...
public class CpuTopology {
    ...
    public String calculateValidTopology(boolean throwException) {
        ...
        if (throwException) {
            throw new OperationFailureException(operr(ORG_ZSTACK_COMPUTE_VM_10223, "cpu topology is not correct, cpuNum[%s], configured cpuSockets[%s], cpuCores[%s], cpuThreads[%s];" +
