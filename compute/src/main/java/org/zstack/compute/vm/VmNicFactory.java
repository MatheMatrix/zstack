...
public class VmNicFactory implements VmInstanceNicFactory {
    ...
    public VmNicVO createVmNic(VmNicInventory nic, VmInstanceSpec spec) {
        ...
        if (vnic == null) {
            throw new FlowException(err(ORG_ZSTACK_COMPUTE_VM_10032, VmErrors.ALLOCATE_MAC_ERROR, "unable to find an available mac address after re-try 5 times, too many collisions"));
        }
