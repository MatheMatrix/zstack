...
public class VmGlobalConfig {
    ...
    @GlobalConfigValidation(numberGreaterThan = 0, numberLessThan = 10000)
    public static GlobalConfig VM_METADATA_MAINTENANCE_CONTENT_DRIFT_BATCH_SLEEP_MS = new GlobalConfig(CATEGORY, "vm.metadata.maintenance.contentDriftBatchSleepMs");
}
