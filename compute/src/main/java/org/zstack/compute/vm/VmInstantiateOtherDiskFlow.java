        ...
        chain.then(new ShareFlow() {
            ...
            public void setup() {
                if (diskAO.getSize() != 0) {
                    ...
                    trigger.fail(operr(ORG_ZSTACK_COMPUTE_VM_10011, "the diskAO parameter is incorrect. need to set one of the following properties, " +
                ...
                flow(new NoRollbackFlow() {
                    ...
                    public void run(final FlowTrigger innerTrigger, Map data) {
                        ...
                        if (vmAttachOtherDiskExtensionPoint == null) {
                            innerTrigger.fail(operr(ORG_ZSTACK_COMPUTE_VM_10012, "the disk does not support attachment. disk type is %s", diskAO.getSourceType()));
                            return;
                        }
