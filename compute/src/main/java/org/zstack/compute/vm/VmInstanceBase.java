...
public class VmInstanceBase extends AbstractVmInstance {
    ...
    private void handle(final DeleteL3NetworkFromVmNicMsg msg) {
        thdf.chainSubmit(new ChainTask(msg) {
            ...
            public void run(final SyncTaskChain chain) {
                ...
                FlowChain fchain = FlowChainBuilder.newSimpleFlowChain();
                fchain.setName(String.format("update-vmNic-%s-to-backend", msg.getVmInstanceUuid()));
                fchain.getData().put(VmInstanceConstant.VmInstanceParams.VmInstanceSpec.toString(), spec);
    ...
    private void attachNic(final Message msg, final List<String> l3Uuids, final ReturnValueCompletion<VmNicInventory> completion) {
        ...
        flowChain.getData().put(VmInstanceConstant.VmInstanceParams.VmAllocateNicFlow_allowDuplicatedAddress.toString(), setStaticIp.allowDupicatedAddress);
        flowChain.getData().put(VmInstanceConstant.VmInstanceParams.VmAllocateNicFlow_nicNetworkInfo.toString(), setStaticIp.nicNetworkInfo);
    ...
    private void setNoIpamStaticIp(final SetVmStaticIpMsg msg, final Completion completion) {
        ...
        chain.getData().put(VmInstanceParams.VmInstanceSpec.toString(), spec);
        chain.getData().put(VmInstanceConstant.VmInstanceParams.VmNicInventory.toString(), vmNicVO);
        chain.then(new ShareFlow() {
            @Override
            public void setup() {
    ...
    private void setVmHostName(String vmInstanceUuid, Completion completion) {
        ...
        chain.allowEmptyFlow();
        chain.getData().put(VmInstanceConstant.VmInstanceParams.VmInstanceUuid.toString(), vmInstanceUuid);
    ...
    private void attachIso(final String isoUuid, String specifiedCdRomUuid, final Completion completion) {
        ...
        chain.getData().put(VmInstanceConstant.VmInstanceParams.AttachingIsoInventory.toString(), iso);
    ...
    private void changeVmNicNetwork(ChangeVmNicNetworkMsg msg, VmNicInventory nic, L3NetworkInventory destL3, final ReturnValueCompletion<VmNicInventory> completion) {
        thdf.chainSubmit(new ChainTask(completion) {
            ...
            public void run(final SyncTaskChain chain) {
                ...
                spec.setL3Networks(list(new VmNicSpec(L3NetworkInventory.valueOf(l3VO))));
                flowChain.getData().put(VmInstanceParams.VmInstanceSpec.toString(), spec);
                flowChain.getData().put(VmInstanceConstant.VmInstanceParams.L3NetworkInventory.toString(), destL3);
                ...
                flowChain.then(new NoRollbackFlow() {
                    ...
                    public void run(FlowTrigger trigger, Map data) {
                        ...
                        data.put(VmInstanceConstant.VmInstanceParams.VmNicInventory.toString(), nicVO);
                        data.put(VmInstanceConstant.VmInstanceParams.vmInventory.toString(), getSelfInventory());
                        trigger.next();
                    }
                });
                ...
                flowChain.done(new FlowDoneHandler(chain) {
                    ...
                    public void handle(ErrorCode errCode, Map data) {
                        ...
                        List<UsedIpInventory> allocateIps = (List<UsedIpInventory>) data.get(VmInstanceConstant.VmInstanceParams.VmAllocateNicFlow_ips.toString());
    ...
    protected void attachDataVolume(final AttachDataVolumeToVmMsg msg, final NoErrorCompletion completion) {
        ...
        chain.getData().put(VmInstanceConstant.VmInstanceParams.AttachedDataVolumeInventories.toString(), attachedVolumes);
