...
public class VmDownloadIsoFlow extends NoRollbackFlow {
    ...
    public void run(final FlowTrigger trigger, Map data) {
        ...
        if (bsUuid == null) {
            throw new OperationFailureException(operr(ORG_ZSTACK_COMPUTE_VM_10027, "cannot find the iso[uuid:%s] in any connected backup storage attached to the zone[uuid:%s]. check below:\n" +
