...
public class BeforeVmStartOnHypervisorFlow extends NoRollbackFlow {
    private static final CLogger logger = Utils.getLogger(BeforeVmStartOnHypervisorFlow.class);
    ...
    public void run(final FlowTrigger chain, final Map data) {
        ...
        Map<String, List<String>> volumesAliveSnapshotChain = VmVolumeSnapshotChainUtil.getVmVolumesAliveSnapshotChain(spec.getVmInventory().getAllDiskVolumes());
