...
public class TransactionSynchronizationAsyncImpl implements TransactionSynchronization {
    ...
    private final TransactionalCallback.TransactionalOperation op;
    
    TransactionSynchronizationAsyncImpl(TransactionalCallback cb, TransactionalCallback.TransactionalOperation op, Class<?>...clazzs) {
        this.clazzs = clazzs;
        this.callback = cb;
        this.op = op;
    }
